...
//определяются значения угловых элементов матрицы A и вычисляется шаг для линейного изменения значений между углами. 
//В цикле вычисляются значения для остальных элементов массива A, начиная с краев и двигаясь к центру матрицы. 
//После этого содержимое массива A копируется в массив Anew с помощью функции memcpy.
